...
public class BurritoSvcImpl implements IBurritoSvc {
	...
	public Burrito getBurrito(Integer id) throws IOException, ClassNotFoundException, Exception {
		...
		try {
			...
			dLog.error("IOException in getBurrito", e1);
		}
		catch (ClassNotFoundException e2) {
			dLog.error("ClassNotFoundException in getBurrito", e2);
		}
		catch(Exception e3) {
			dLog.error("Exception in getBurrito", e3);
		}
		finally {
	...
	public boolean storeBurrito(Burrito b) throws IOException, Exception {
		...
		try {
			...
			dLog.error("IOException in storeBurrito: ", e1);
		}
		catch(Exception e2) {
